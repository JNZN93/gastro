...
export const routes: Routes = [
    ...
    { path: 'offers', component: OffersComponent, canActivate: [AdminAuthGuard] },
    { path: 'offers/:id/flyer', component: OfferFlyerComponent, canActivate: [AdminAuthGuard] },
    { path: 'customer-price-overview', component: CustomerPriceOverviewComponent, canActivate: [AdminAuthGuard] },
    { path: 'device-tracking', component: DeviceTrackingComponent, canActivate: [AdminAuthGuard] },
    {
        path: 'picking',
        loadChildren: () =>
